...
前章では talker・listener・roscore を **3 つのターミナル** で別々に起動しました。ノードが増えるたびにターミナルを開くのは不便です。**launch ファイル** を使うと、複数のノードを 1 コマンドで起動できます。
...
パラメータの読み取り方は [8章: パラメータ](08_parameters.md) で詳しく説明します。
