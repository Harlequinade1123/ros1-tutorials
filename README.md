...
> **重要**: ROS 1 Noetic は **2025年5月31日にEOL（公式サポート終了）** となりました．既存のバイナリは引き続き配布されていますが，新しい機能・バグ修正・セキュリティ更新・新規バイナリは提供されません．本教材は既存環境の学習・保守を目的としています．新規システムには、サポート中のROS 2ディストリビューションを使用してください．
...
> ROS 1とROS 2では、同じ名前の概念でもAPIや動作が異なる場合があります．ROS 2版は同じ親ディレクトリの `ros2-tutorials` を参照してください．
